...
import com.cortxt.app.mmcutility.CoverageSamples.EvtSample;
...
public class TrendStringGenerator {
	 ...
	 * @return
	 */
	public CoverageSamplesSend generateSamples (Cursor cellDataCursor, Cursor locationDataCursor, Cursor signalDataCursor, MMCService context, EventObj event){
		int i;

				...
				private void getAddress(final HashMap<String, String> event) {
					if (event.containsKey(ReportManager.EventKeys.LATITUDE) && event.containsKey(ReportManager.EventKeys.LONGITUDE)) {
						...
						Runnable r = new Runnable() {
							...
							@Override
							public void run() {
								String addressString = WebReporter.geocode(Double.parseDouble(event.get(ReportManager.EventKeys.LATITUDE)), Double.parseDouble(event.get(ReportManager.EventKeys.LONGITUDE)));

...
import com.cortxt.app.mmcutility.ContentProvider.TablesOld.Locations;
...
public class ContentValuesGeneratorOld {
	...
	public ContentValuesGeneratorOld(Context context){
	 ...
	 * @return
	 */
	public static ContentValues generateFromSignal(MMCSignal signal, int phoneType, int networkType, int serviceState, int dataState, long stagedEventId, int wifiSignal, JSONObject serviceMode){
		ContentValues values = new ContentValues();
		Integer dBm = 0;
...
//			}
	...
	private static String listSignalFields (MMCSignal mmcsignal)
	{
		int i;
		String strSignals = "";
	 ...
	 * @return
	 */
	public static ContentValues generateFromCellLocation(MMCCellLocation cellLoc, long stagedEventId){
		ContentValues values = new ContentValues();

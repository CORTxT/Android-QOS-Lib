...
public class PhoneState {
    ...
    //last data caches
    public MMCCellLocation lastKnownMMCCellLocation;
    ...
    public MMCSignal lastKnownMMCSignal;
...
//        MMCLogger.logToFile(MMCLogger.Level.WTF, TAG, "setCallConnected", connected + " " + timeConnected);
    ...
    public MMCSignal getLastMMCSignal(){
    ...
    {
        int i;
        MMCSignal mmcsignal = getLastMMCSignal();
        String strSignals = "";

 ...
 *
 */ 
public class MMCSignal {
	protected SignalStrength signalStrength;
	protected long timestamp;
	public static final String TAG = MMCSignal.class.getSimpleName();
	/*
	 * Getters and setters
	 */
	 ...
	 * Constructor
	 */
	public MMCSignal(){ // null signal, means signal unknown
		this.timestamp = System.currentTimeMillis(); //new Time(Time.getCurrentTimezone());
		
	}
	public MMCSignal(SignalStrength signalStrength){
